...
public class VoiceModTest {
	...
	public void setUp() throws Exception {
		...
		System.setProperty("webdriver.firefox.driver", "\\resources\\windows\\geckodriver.exe");
	...
	@Test
	public void voiceModTitleTest() throws InterruptedException, IOException {
		String title = driver.getTitle();
		System.out.println("title is: " + title);
		getRunTimeInfoMessage("info", title);

		if (title.equals("Free Real Time Voice Changer &amp; Modulator - Voicemod")) {
